...
// static fp/index.html + pd/index.html and js/router.js, which sets
// window.LINEUP_FANTA.league and document.documentElement.dataset.leagueSection.
// This hook is the React-side read of that same state, so the dashboard does
// not need react-router-dom and stays in sync with the vanilla bridge.
