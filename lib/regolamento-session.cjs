/* Sessione Google Docs pub: mantiene i cookie di sessione per lega.
   Le immagini docs-images-rt richiedono il cookie rilasciato dalla pagina pub;
   ogni documento ha una propria sessione, quindi il jar è chiavato per lega. */
"use strict";
